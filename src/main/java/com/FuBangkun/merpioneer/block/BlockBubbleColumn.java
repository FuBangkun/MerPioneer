package com.FuBangkun.merpioneer.block;

import com.FuBangkun.merpioneer.client.particle.ParticleBubbleColumnUp;
import com.FuBangkun.merpioneer.client.particle.ParticleCurrentDown;
...
public class BlockBubbleColumn extends BlockStaticLiquid {
    ...
    public BlockBubbleColumn() {
        ...
        this.setTranslationKey("tile.merpioneer.bubble.column.name");
