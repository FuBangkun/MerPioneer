package com.FuBangkun.merpioneer.client.model;
...
public class WaterResourcePack extends AbstractResourcePack {
    ...
    protected InputStream getInputStreamByName(String name) {
        if (name.equals("pack.mcmeta")) {
            return MerPioneer.class.getResourceAsStream("/water_pack.mcmeta");
        }
        String truePath = "/" + name.replace("minecraft", "merpioneer/overrides");
        return MerPioneer.class.getResourceAsStream(truePath);
    }
